...
public class FireStationApiServiceTest {
	...
	@Test
	public void getPersonsDataForAnaddressNoEmptyReturn() throws IOException {
		// GIVEN
		List<Person> personsList = new ArrayList<>();
		personsList = personService.getPersons();
		String address = personsList.get(0).getAddress();
		List<Map<String, String>> personMap = new ArrayList<>();

		// WHEN
		personMap = service.getPersonsDataForAnaddressWithStationNumber(address);

		// THEN
		assertThat(personMap).isNotEmpty();
	}

	@Test
	public void getPersonsDataForFireStationListNoEmptyReturn() throws IOException {
		// GIVEN
		List<FireStation> fireStationsList = service.getFireStations();
		List<String> stationsList = new ArrayList<>();
		stationsList.add(fireStationsList.get(0).getStationNumber()); // station 3
		stationsList.add(fireStationsList.get(1).getStationNumber()); // station 2
		List<Map<String, String>> personMap = new ArrayList<>();

		// WHEN
		personMap = service.getPersonsDataForFireStationList(stationsList);
	...
	@Test
	public void getPersonsDataForFireStationListEmptyReturnForWrongStationNumber() throws IOException {
		// GIVEN
		List<String> stationsList = new ArrayList<>();
		stationsList.add("5");
		List<Map<String, String>> personMap = new ArrayList<>();
